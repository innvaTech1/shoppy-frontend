  ...
  useEffect(() => {
    if (res) {
      if (route && route.query) {
        axios
          .get(
            `${process.env.NEXT_PUBLIC_BASE_URL}api/callback/google?authuser=${route.query.authuser}&code=${route.query.code}&prompt=${route.query.prompt}&scope=${route.query.scope}`
          )
          .then((res) => {
